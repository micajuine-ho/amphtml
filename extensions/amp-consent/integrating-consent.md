...
- Meet the restrictions that the AMP runtime applies to ensure a good user experience. These includes
  ...
  - Enforce the size of the stored consent information. 1200 character length including storage key, consent string and additional metadata is the limit. Please [file an issue](https://github.com/ampproject/amphtml/issues/new) if you find that not sufficient. hi.
